...
parser.add_argument("--share-password", type=str, help="Sharing is open by default, use this to set a password. Username: alpha", default="demo")
...
class ServerLauncher(threading.Thread):
    ...
    def run(self):
        ...
        if opt.share and opt.share_password:
            gradio_params['auth'] = ('alpha', opt.share_password)    
